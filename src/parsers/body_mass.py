...
from src.pylib.convert_units import convert
from src.pylib.numeric import add_flags, as_value, simple_mass
...
BODY_MASS = Base(
    ...
    rules=[
        ...
        VOCAB.producer(
            simple_mass, ' ( key | triple_key ) mass_range mass_units '),
        VOCAB.producer(
