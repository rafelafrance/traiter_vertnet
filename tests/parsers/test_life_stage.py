...
class TestLifeStage(unittest.TestCase):
    ...
    def test_parse_02(self):
        self.assertEqual(
            LIFE_STAGE.parse("age=u ad."), [Trait(value="u ad.", start=0, end=9)]
        )
    ...
    def test_parse_04(self):
        self.assertEqual(
            LIFE_STAGE.parse("sex=female ? ; age=1st year more than four words here"),
    ...
    def test_parse_06(self):
        self.assertEqual(LIFE_STAGE.parse("age determined by 20-sided die"), [])
    ...
    def test_parse_11(self):
        self.assertEqual(
            LIFE_STAGE.parse("adults"), [Trait(value="adults", start=0, end=6)]
        )

    def test_parse_12(self):
        self.assertEqual(
            LIFE_STAGE.parse("Adulte"), [Trait(value="adulte", start=0, end=6)]
        )

    def test_parse_13(self):
        self.assertEqual(
            LIFE_STAGE.parse("AGE IMM"), [Trait(value="imm", start=0, end=7)]
        )

    def test_parse_14(self):
        self.assertEqual(
            LIFE_STAGE.parse("subadult"), [Trait(value="subadult", start=0, end=8)]
        )

    def test_parse_15(self):
        self.assertEqual(LIFE_STAGE.parse("subadultery"), [])
    ...
    def test_parse_17(self):
        self.assertEqual(
            LIFE_STAGE.parse("one tadpole"), [Trait(value="tadpole", start=4, end=11)]
        )

    def test_parse_18(self):
        # Life stage removed
        self.assertEqual(LIFE_STAGE.parse("some embryos"), [])
    ...
    def test_parse_21(self):
        self.assertEqual(
            LIFE_STAGE.parse("sub-adult"), [Trait(value="sub-adult", start=0, end=9)]
        )
    ...
    def test_parse_24(self):
        self.assertEqual(
            LIFE_STAGE.parse("YOLK SAC"), [Trait(value="yolk sac", start=0, end=8)]
        )
