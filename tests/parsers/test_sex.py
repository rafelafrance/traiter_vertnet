...
class TestSex(unittest.TestCase):
    def test_parse_01(self):
        self.assertEqual(
            SEX.parse("sex=female ?"), [Trait(value="female ?", start=0, end=12)]
        )
    ...
    def test_parse_06(self):
        self.assertEqual(SEX.parse("Respective sex and msmt. in mm"), [])
    ...
    def test_parse_09(self):
        self.assertEqual(
            SEX.parse("sex=female?"), [Trait(value="female?", start=0, end=11)]
        )
