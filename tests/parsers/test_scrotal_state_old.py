...
class TestScrotalState(unittest.TestCase):
    ...
    def test_parse_04(self):
        self.assertEqual(
            SCROTAL_STATE.parse("testes ns"), [Trait(value="testes ns", start=0, end=9)]
        )

    def test_parse_05(self):
        self.assertEqual(
            SCROTAL_STATE.parse("t nscr"), [Trait(value="t nscr", start=0, end=6)]
        )

    def test_parse_06(self):
        self.assertEqual(
            SCROTAL_STATE.parse("t ns"), [{"end": 4, "start": 0, "value": "t ns"}]
        )
