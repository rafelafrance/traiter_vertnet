...
class TestOvariesState(unittest.TestCase):
    def test_parse_01(self):
        self.assertEqual(
            OVARIES_STATE.parse(
                "sex=female ; " "reproductive data=Ovaries and uterus small, immature"
            ),
    ...
    def test_parse_08(self):
        self.assertEqual(
            OVARIES_STATE.parse("reproductive data=Ovary, fallopian tubes dark red."),
    ...
    def test_parse_11(self):
        self.assertEqual(
            OVARIES_STATE.parse("reproductive data=Ovaries and uterus small, immature"),
    ...
    def test_parse_13(self):
        self.assertEqual(
            OVARIES_STATE.parse("reproductive data=Ovaries minute, not embryos."),
    ...
    def test_parse_15(self):
        self.assertEqual(
            OVARIES_STATE.parse("reproductive data=pelvis fused, ovaries inactive;"),
    ...
    def test_parse_19(self):
        self.assertEqual(
            OVARIES_STATE.parse("ovaries imm."), [Trait(value="imm", start=0, end=11)]
        )
    ...
    def test_parse_21(self):
        self.assertEqual(
            ...
            [Trait(value="corpus luteum visible", side="both", start=0, end=37)],
        )

    def test_parse_22(self):
        self.assertEqual(
            OVARIES_STATE.parse("reproductive data=only 1 fully developed ovary ;"),
    ...
    def test_parse_32(self):
        self.assertEqual(
            OVARIES_STATE.parse("ovaries well developed, but not pregnant apparently;"),
    ...
    def test_parse_34(self):
        self.assertEqual(
            OVARIES_STATE.parse("Yng. 7 blastocysts and 2 ovaries preserved (where?)"),
            [],
        )
