"""Test hind foot length notations."""
...
class TestHindFootLength(unittest.TestCase):
    ...
    def test_parse_02(self):
        self.assertEqual(
            ...
            [Trait(value=36, units="MM", units_inferred=False, start=1, end=24)],
        )

    def test_parse_03(self):
        self.assertEqual(
            HIND_FOOT_LENGTH.parse('"hind foot length":"34.0"'),
            [Trait(value=34, units=None, units_inferred=True, start=1, end=24)],
        )

    def test_parse_04(self):
        self.assertEqual(
            HIND_FOOT_LENGTH.parse("; HindFoot: 30.0; "),
            [Trait(value=30, units=None, units_inferred=True, start=2, end=16)],
        )
    ...
    def test_parse_07(self):
        self.assertEqual(
            ...
            [Trait(value=29, units=None, units_inferred=True, start=9, end=15)],
        )

    def test_parse_08(self):
        self.assertEqual(
            HIND_FOOT_LENGTH.parse("T-94mm, HF-30mm, E/n-19mm,"),
            [Trait(value=30, units="mm", units_inferred=False, start=8, end=15)],
        )
    ...
    def test_parse_12(self):
        self.assertEqual(
            ...
            [
                Trait(
                    value=31, units="Millimeters", units_inferred=False, start=1, end=29
                )
            ],
        )
    ...
    def test_parse_17(self):
        self.assertEqual(
            HIND_FOOT_LENGTH.parse("2010:15,27,41,69,106-107.112-115,118-128;"), []
        )
