...
class TestTragusLength(unittest.TestCase):
    def test_parse_01(self):
        self.assertEqual(
            ...
            [Trait(value=7, units=None, units_inferred=True, start=0, end=8)],
        )

    def test_parse_02(self):
        self.assertEqual(
            TRAGUS_LENGTH.parse("tragus-5 "),
            [Trait(value=5, units=None, units_inferred=True, start=0, end=8)],
        )

    def test_parse_03(self):
        self.assertEqual(
            TRAGUS_LENGTH.parse("; tragus length=9 mm;"),
            [Trait(value=9, units="mm", units_inferred=False, start=2, end=20)],
        )
    ...
    def test_parse_04(self):
        self.assertEqual(
            ...
            [Trait(value=6, units="MM", units_inferred=False, start=98, end=118)],
        )
