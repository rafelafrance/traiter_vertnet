...
class TestPlacentalScarCount(unittest.TestCase):
    ...
    def test_parse_04(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("4 plac scar"), [Trait(value=4, start=0, end=11)]
        )
    ...
    def test_parse_15(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("not breeding, two scars, 1 left, 1 right"),
    ...
    def test_parse_27(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("VO, pg., 1 embryo (discarded), CRL+28 mm"), []
        )
    ...
    def test_parse_33(self):
        self.assertEqual(PLACENTAL_SCAR_COUNT.parse("; 1 scar on tail ;"), [])
    ...
    def test_parse_38(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("ut horns: R 1 definite scar, L 2+ scars;"),
    ...
    def test_parse_43(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("Zion 11396; NK 36683; scars/no embs/lact"),
    ...
    def test_parse_47(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("no embryonic scars 360-40-125-68 1800g"),
            [Trait(value=0, start=0, end=18)],
        )
    ...
    def test_parse_53(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("corp. lut. 4L, 3R, scars 3L, 3R, no embryos"),
    ...
    def test_parse_56(self):
        self.assertEqual(
            PLACENTAL_SCAR_COUNT.parse("reproductive data=nip small, no plsc ; "),
