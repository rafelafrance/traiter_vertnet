...
class TestNipplesEnlarged(unittest.TestCase):
    ...
    def test_parse_07(self):
        self.assertEqual(
            NIPPLES_ENLARGED.parse('Nipples pigmented.'),
            [])
    ...
    def test_parse_09(self):
        self.assertEqual(
            NIPPLES_ENLARGED.parse('; teats visible,'),
            [])
    ...
    def test_parse_11(self):
        self.assertEqual(
            NIPPLES_ENLARGED.parse('4 teats post lac.'),
            [])
    ...
    def test_parse_14(self):
        self.assertEqual(
            NIPPLES_ENLARGED.parse('mammary glands active'),
            [])
    ...
    def test_parse_16(self):
        self.assertEqual(
            NIPPLES_ENLARGED.parse('; MAMMARY TISSSUE ABSENT;'),
            [])
    ...
    def test_parse_20(self):
        self.assertEqual(
            NIPPLES_ENLARGED.parse('nipples medium'),
            [])
