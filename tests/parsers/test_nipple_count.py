...
class TestNippleCount(unittest.TestCase):
    ...
    def test_parse_04(self):
        self.assertEqual(NIPPLE_COUNT.parse("mammae 2+2"), [])
    ...
    def test_parse_08(self):
        self.assertEqual(
            ...
            [Trait(value=6, notation="1 pr + 2 pr = 6", start=1, end=24)],
        )
    ...
    def test_parse_11(self):
        self.assertEqual(NIPPLE_COUNT.parse("98 mammalian jaws and jaw fragments,"), [])

    def test_parse_12(self):
        self.assertEqual(NIPPLE_COUNT.parse("; CR-9; mammary tissue present;"), [])

    def test_parse_13(self):
        self.assertEqual(NIPPLE_COUNT.parse("a fauna of about 800 mammal teeth"), [])

    def test_parse_14(self):
        self.assertEqual(NIPPLE_COUNT.parse("MISC. # IS 70034, NIPPLES ENLARGED"), [])

    def test_parse_15(self):
        self.assertEqual(
            NIPPLE_COUNT.parse("Source: MRS. ID# 42-1111.  Mammary development,"), []
        )

    def test_parse_16(self):
        self.assertEqual(NIPPLE_COUNT.parse("CR:14 LG TEATS 98% LEAF,2%"), [])

    def test_parse_17(self):
        self.assertEqual(NIPPLE_COUNT.parse("reproductive data=mammae (4L, 5R)"), [])
