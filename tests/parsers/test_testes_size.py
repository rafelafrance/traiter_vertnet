...
class TestTestesSize(unittest.TestCase):
    ...
    def test_parse_03(self):
        self.assertEqual(
            TESTES_SIZE.parse("ear from notch=19 mm; reproductive data=testis 5mm ; "),
    ...
    def test_parse_06(self):
        self.assertEqual(
            ...
            [Trait(value=[21, 11], units=None, units_inferred=True, start=27, end=37)],
        )

    def test_parse_07(self):
        self.assertEqual(
            TESTES_SIZE.parse("; reproductive data=testes scrotal; T = 9mm in length"),
    ...
    def test_parse_12(self):
        self.assertEqual(
            ...
            [Trait(value=[13, 5], units="mm", units_inferred=False, start=18, end=31)],
        )
    ...
    def test_parse_22(self):
        self.assertEqual(
            ...
            [Trait(value=[5, 3.5], units="MM", units_inferred=False, start=0, end=15)],
        )
    ...
    def test_parse_34(self):
        self.assertEqual(
            ...
            [
                ...
                Trait(
                    value=6, units="mm", units_inferred=False, side="l", start=2, end=33
                ),
            ],
        )
    ...
    def test_parse_41(self):
        self.assertEqual(TESTES_SIZE.parse("0abd6b4f-e836-49ad-80e8-4ce47bffa190;"), [])
