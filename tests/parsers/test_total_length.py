...
class TestTotalLength(unittest.TestCase):
    def test_parse_001(self):
        self.assertEqual(
            ...
            [Trait(value=123, units_inferred=False, units="MM", start=2, end=23)],
        )
    ...
    def test_parse_002(self):
        self.assertEqual(
            ...
            [
                ...
                Trait(value=231, units_inferred=False, units="mm", start=42, end=61),
            ],
        )
    ...
    def test_parse_004(self):
        self.assertEqual(TOTAL_LENGTH.parse("sex=unknown ; crown-rump length=8 mm"), [])

    def test_parse_005(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("left gonad length=10 mm; right gonad length=10 mm;"), []
        )
    ...
    def test_parse_008(self):
        self.assertEqual(
            ...
            [
                ...
                Trait(value=111, units="mm", units_inferred=False, start=25, end=44),
            ],
        )
    ...
    def test_parse_009(self):
        self.assertEqual(
            ...
            [
                ...
                Trait(value=231, units="mm", units_inferred=False, start=71, end=90),
            ],
        )
    ...
    def test_parse_018(self):
        self.assertEqual(
            ...
            [Trait(value=120, units=None, units_inferred=True, start=9, end=15)],
        )

    def test_parse_019(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("another; TL - 101.3mm, noise"),
            [Trait(value=101.3, units="mm", units_inferred=False, start=9, end=21)],
        )

    def test_parse_020(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("before; TL153, after"),
            [Trait(value=153, units=None, units_inferred=True, start=8, end=13)],
        )
    ...
    def test_parse_022(self):
        self.assertEqual(
            ...
            [Trait(value=[16, 23], units="mm", units_inferred=False, start=7, end=48)],
        )
    ...
    def test_parse_025(self):
        self.assertEqual(
            ...
            [Trait(value=52, units="mm", units_inferred=False, start=0, end=7)],
        )
    ...
    def test_parse_026(self):
        self.assertEqual(
            ...
            [
                Trait(value=221, units="mm", units_inferred=False, start=0, end=24),
                Trait(value=257, units="mm", units_inferred=False, start=26, end=45),
            ],
        )
    ...
    def test_parse_027(self):
        self.assertEqual(
            ...
            [
                Trait(value=209, units="mm", units_inferred=False, start=0, end=10),
                Trait(value=272, units="mm", units_inferred=False, start=12, end=24),
            ],
        )

    def test_parse_028(self):
        self.assertEqual(
            TOTAL_LENGTH.parse('{"time collected":"0712-0900", "length":"12.0" }'),
            [
                Trait(
                    value=12,
                    ambiguous_key=True,
    ...
    def test_parse_030(self):
        self.assertEqual(
            ...
            [
                Trait(value=44, units="mm", units_inferred=False, start=0, end=10),
                Trait(value=38, units="mm", units_inferred=False, start=11, end=21),
            ],
        )
    ...
    def test_parse_034(self):
        self.assertEqual(
            ...
            [
                Trait(
                    value=[63, 107], units="mm", units_inferred=False, start=20, end=45
                )
            ],
        )
    ...
    def test_parse_036(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("age class: adult; standard length: 18.0-21.5mm"),
            [
                Trait(
                    value=[18, 21.5], units="mm", units_inferred=False, start=18, end=46
                )
            ],
        )
    ...
    def test_parse_037(self):
        self.assertEqual(
            ...
            [
                Trait(
                    value=[18, 21.5], units="mm", units_inferred=False, start=18, end=44
                )
            ],
        )
    ...
    def test_parse_038(self):
        self.assertEqual(
            ...
            [Trait(value=[18, 21], units="mm", units_inferred=False, start=18, end=44)],
        )

    def test_parse_039(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("age class: adult; standard length: 18-21mm"),
            [Trait(value=[18, 21], units="mm", units_inferred=False, start=18, end=42)],
        )
    ...
    def test_parse_041(self):
        self.assertEqual(
            ...
            [Trait(value=[20, 28], units="mm", units_inferred=False, start=0, end=10)],
        )

    def test_parse_042(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("29mm SL"),
            [Trait(value=29, units="mm", units_inferred=False, start=0, end=7)],
        )
    ...
    def test_parse_044(self):
        self.assertEqual(TOTAL_LENGTH.parse("c701563b-dbd9-4500-184f-1ad61eb8da11"), [])

    def test_parse_045(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("Meas: L: 21.0"),
            [Trait(value=21, units=None, units_inferred=True, start=0, end=13)],
        )
    ...
    def test_parse_047(self):
        self.assertEqual(
            ...
            [Trait(value=375, units="MM", units_inferred=False, start=0, end=20)],
        )

    def test_parse_048(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("SL=12mm"),
            [Trait(value=12, units="mm", units_inferred=False, start=0, end=7)],
        )

    def test_parse_049(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("Size=SL 12-14 mm"),
            [Trait(value=[12, 14], units="mm", units_inferred=False, start=5, end=16)],
        )
    ...
    def test_parse_051(self):
        self.assertEqual(
            ...
            [Trait(value=123, units="mm", units_inferred=False, start=1, end=18)],
        )

    def test_parse_052(self):
        self.assertEqual(
            TOTAL_LENGTH.parse(" Length: 12-34 mmSL"),
            [Trait(value=[12, 34], units="mm", units_inferred=False, start=1, end=19)],
        )
    ...
    def test_parse_054(self):
        self.assertEqual(
            ...
            [Trait(value=44, units=None, units_inferred=True, start=0, end=6)],
        )

    def test_parse_055(self):
        self.assertEqual(TOTAL_LENGTH.parse("SVL=0 g"), [])
    ...
    def test_parse_057(self):
        self.assertEqual(
            ...
            [Trait(value=50, units=None, units_inferred=True, start=0, end=5)],
        )

    def test_parse_058(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("SVL=44mm"),
            [Trait(value=44, units="mm", units_inferred=False, start=0, end=8)],
        )

    def test_parse_059(self):
        self.assertEqual(TOTAL_LENGTH.parse("SV 1.4, TAIL 1.0 CM. HATCHLING"), [])

    def test_parse_060(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("LENGTH 10 3/8 IN. WING CHORD 5.25 IN. TAIL 4.25 IN."),
            [
                Trait(
                    value=263.52,
                    ambiguous_key=True,
    ...
    def test_parse_063(self):
        self.assertEqual(TOTAL_LENGTH.parse("set mark: 661 1-5 64-61"), [])

    def test_parse_064(self):
        self.assertEqual(
            TOTAL_LENGTH.parse('{"totalLength":"970", "wing":"390" }'),
            [Trait(value=970, units=None, units_inferred=True, start=2, end=19)],
        )

    def test_parse_065(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("LENGTH: 117MM. SOFT self.parserTS COLOR ON LABEL."),
            [
                Trait(
                    value=117,
                    units="MM",
    ...
    def test_parse_066(self):
        self.assertEqual(
            ...
            [Trait(value=5, units=None, units_inferred=True, start=0, end=18)],
        )

    def test_parse_067(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("Size=41-148mm SL"),
            [Trait(value=[41, 148], units="mm", units_inferred=False, start=5, end=16)],
        )

    def test_parse_068(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("Size=105 mm TL, 87.1 mm PCL"),
            [Trait(value=105, units="mm", units_inferred=False, start=5, end=14)],
        )
    ...
    def test_parse_069(self):
        self.assertEqual(
            ...
            [
                Trait(
                    value=[185, 252], units="mm", units_inferred=False, start=0, end=24
                )
            ],
        )
    ...
    def test_parse_070(self):
        self.assertEqual(
            ...
            [
                Trait(
                    value=[185, 252], units="mm", units_inferred=False, start=0, end=26
                )
            ],
        )
    ...
    def test_parse_075(self):
        self.assertEqual(TOTAL_LENGTH.parse("10 12/07/1944"), [])

    def test_parse_076(self):
        self.assertEqual(TOTAL_LENGTH.parse("12-07-1944"), [])
    ...
    def test_parse_079(self):
        self.assertEqual(TOTAL_LENGTH.parse("measurements:210-92-30 185-252 mm"), [])

    def test_parse_080(self):
        self.assertEqual(TOTAL_LENGTH.parse("reproductive data=scars R2, L2 ;"), [])

    def test_parse_081(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("LENGTH 3/8 IN. WING CHORD 5.25 IN. TAIL 4.25 IN."),
            [
                Trait(
                    value=9.52,
                    ambiguous_key=True,
    ...
    def test_parse_082(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("LENGTH 0 3/8 IN. WING CHORD 5.25 IN. TAIL 4.25 IN."),
            [
                Trait(
                    value=9.52,
                    ambiguous_key=True,
    ...
    def test_parse_083(self):
        self.assertEqual(
            ...
            [Trait(value=[42, 51], units="mm", units_inferred=False, start=25, end=36)],
        )

    def test_parse_084(self):
        self.assertEqual(
            TOTAL_LENGTH.parse("verbatim collector=R. D. Svihla 31-605 ; sex=male"), []
        )
    ...
    def test_parse_086(self):
        self.assertEqual(
            ...
            [Trait(value=141, units="mm", units_inferred=False, start=23, end=36)],
        )
    ...
    def test_parse_100(self):
        self.assertEqual(
            ...
            [Trait(value=1260, units=None, units_inferred=True, start=30, end=46)],
        )
    ...
    def test_parse_102(self):
        self.assertEqual(
            ...
            [Trait(value=1487.5, units=None, units_inferred=True, start=30, end=48)],
        )
    ...
    def test_parse_104(self):
        self.assertEqual(TOTAL_LENGTH.parse("; trap identifier=SV01 S29/40 ;"), [])
